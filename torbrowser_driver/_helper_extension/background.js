...
function routeOnBeforeRequest(details) {
  // Mock-mode routes are fulfilled on the proxy-intercept substrate
  // and never reach the extension; the extension only handles
  // redirect-mode here. Header rewrite and offline are wired through
  // their own listeners.
