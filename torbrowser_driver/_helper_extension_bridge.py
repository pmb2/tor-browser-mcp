...
class _Handler(BaseHTTPRequestHandler):
    ...
    def _serve_host(self, bridge: HelperBridge) -> None:
        ...
        Some smoke tests and consumers need a page on the bridge origin
        to make cross-origin page-context fetches from -- ``data:``
        URL documents cannot make those fetches in Tor Browser. The
        endpoint is intentionally unauthenticated: page principals
        cannot attach the bridge's bearer token.
        """
